						...
						<div <?php post_class('tf-post');?>>
							...
							<div class="tf-content">
								...
								<div class="tf-entry-meta">
									...
									if ( comments_open() ) { ?>
											<span class="comments">
											<?php comments_popup_link( __( '<i class="fa-regular fa-comment"></i> No Comments', 'shoppingcart' ), __( '<i class="fa-regular fa-comment"></i> 1 Comment', 'shoppingcart' ), __( '<i class="fa-regular fa-comment"></i> % Comments', 'shoppingcart' ), '', __( 'Comments Off', 'shoppingcart' ) ); ?> </span>
									<?php } ?>
